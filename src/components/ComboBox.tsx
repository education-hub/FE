...
interface ComboBoxEditSchoolType {
  defaultFill?: string | number;
  title: string;
  datas: any[];
  name: string | any;
  register?: any;
  error?: string;
  setValue: UseFormSetValue<SchemaEditchSchool>;
  onChange?: (value: number) => void;
}

interface ComboBoxTypeStudent {
  title: string;
  datas: any[];
  name: string | any;
  register?: any;
  error?: string;
  setValue: UseFormSetValue<SchemaStudent>;
  onChange?: (value: number) => void;
}
...
export const ComboBoxEditSchool: FC<ComboBoxEditSchoolType> = (props) => {
  const {
    title,
    datas,
    register,
...
export const ComboBoxStudent: FC<ComboBoxTypeStudent> = (props) => {
